    ...
    var viewportHeight = $(window).height(), // Viewport Height
      ...
      $(document).ready(function(){
        ...
        $('#section2 > div').mouseenter(function(){
          ...
          $(this).find('.overlap4 > div:nth-child(1)').stop().addClass('midFade'); // 페이드이미지>타이틀 올라옴
        $(this).find('.overlap4 > div:nth-child(1)').stop().css('opacity','1');  // 페이드이미지>타이틀 보임
        $(this).find('.overlap4 > div:nth-child(2)').stop().fadeIn(100); // 페이드이미지 >텍스트 보임
      });
