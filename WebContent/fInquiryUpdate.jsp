...
<body onload="noBack();" onpageshow="if(event.persisted) noBack();" onunload="">
  ...
  <div class="wrap0">
    <section>
      ...
      <form action="inquiryUpdate.fd" method="post" onsubmit="return isLogin()">
        <input type="hidden" name="id" value="${inquiry.getId()}">
        <div>
          <input type="text" name="title" placeholder="제목을 입력해주세요" value="${inquiry.getTitle()}">
          <textarea name="contents" placeholder="내용을 입력해주세요">${inquiry.getContents()}</textarea>
        </div>
