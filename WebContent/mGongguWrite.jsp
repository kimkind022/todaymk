		...
		<section id="section1200">
			...
			<div id="contents">
				<div>
					...
					<c:choose>
						<c:when test="${paramId eq ID}">
							<a href="vege.user?command=myGonggu" class="showMore">뒤로가기</a>
						</c:when>
						<c:otherwise>
							<a href="vege.user?command=myGonggu&id=${paramId }" class="showMore">뒤로가기</a>
						</c:otherwise>
					</c:choose>
				</div>
				<%
				...
				<div class="gongguPost">
					...
					<div class="gongguTxt">
						<ul>
							...
							<li><span class="font10">n월 n일 까지 &nbsp;&nbsp;<%=articleList.get(i).getEndDateTrans()%> 마감</span></li>
							<!-- progress, 마감 시 회색 -->
							<%
