	...
	<section class="section0">
				...
				<div class="subImages-Container">	
					<ul class="subImages">
						<li style="width:100px; height:100px;">
							 <img src="images/store/<%=productList.getImageNo1()%>" width="100px">	
						</li>
						<li style="width:100px; height:100px;">
							<img src="images/store/<%=productList.getImageNo2()%>" width="100px">	
						</li>
						<li style="width:100px; height:100px;">
							<img src="images/store/<%=productList.getImageNo3()%>" width="100px">
						</li>
						<li style="width:100px; height:100px;">
  							<img src="images/store/<%=productList.getImageNo4()%>" width="100px">	
						</li>
						<li style="width:100px; height:100px;">
							<img src="images/store/<%=productList.getImageNo5()%>" width="100px">	
						</li>
					</ul>
				</div>	
			</div>
		...
		<div class="section2">
			...
			<div class="product-info">
				<a name="product-info">
					<img src="images/store/<%=productList.getInfo()%>">
				</a>	
					...
					%>
						<div class="consumerInfo">
							...
							<div class="">
								...
								<p>상품구매일:	
								<p>평점: <%=reviewList.get(i).getRating() %> </p>
							</div>	
						</div>	
						...
						<div id="pageList">	<!-- 페이지 숫자  -->
							...
							[이전]&nbsp;
							<%}else{ %>
							<a href="productDetail.pd?id=<%=productList.getId()%>&page=<%=nowPage-1 %>">[이전]</a>&nbsp;
							<%} %>
							...
							%>
									<a href="productDetail.pd?id=<%=productList.getId()%>&page=<%= i %>">
										[<%= i %>]
									</a>&nbsp;
								<%} %>
							<%} %>
							...
							<%if(nowPage>=maxPage){ %>
								[다음]
							<%}else{ %>
							<a href="productDetail.pd?id=<%=productList.getId()%>&page=<%=nowPage+1 %>">[다음]</a>
							<%} %>
						</div>
